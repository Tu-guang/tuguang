package com.tuguang.tuguangapiclientsdk.client;
...
import static com.tuguang.tuguangapiclientsdk.utils.SignUtils.genSign;
...
//        hashMap.put("secretKey", secretKey);
    ...
    private Map<String, String> getHeaderMaps(String body, String header) {
        Map<String, String> hashMap = new HashMap<>();
        hashMap.put("accessKey", accessKey);
        // 一定不能直接发送
//        hashMap.put("secretKey", secretKey);
